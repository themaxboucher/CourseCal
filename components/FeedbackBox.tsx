...
export default function FeedbackBox() {
  return (
    <Popover>
      <PopoverTrigger className="fixed z-20 bottom-4 right-4 md:bottom-6 md:right-6 p-3 rounded-full bg-foreground text-background shadow-md hover:shadow-lg hover:cursor-pointer">
