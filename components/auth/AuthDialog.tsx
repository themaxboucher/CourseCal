...
export function AuthDialog({ open, onOpenChange, type }: AuthDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        containerClassName="items-start md:items-center" // Pin dialog to top on mobile, so it sit's above the keyboard
        className="sm:max-w-sm flex flex-col items-center gap-8"
      >
